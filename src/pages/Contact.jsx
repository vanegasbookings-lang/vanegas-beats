export default function Contact() {
  return (
    <main style={{minHeight:'100vh',color:'#f5f2ed',fontFamily:"'Space Grotesk', sans-serif",display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',textAlign:'center',padding:'6rem 2.5rem',position:'relative',backgroundImage:"url('/src/assets/mic.jpg')",backgroundSize:'cover',backgroundPosition:'center'}}>
      ...
      <div style={{position:'relative',zIndex:1}}>
        ...
        <div style={{display:'flex',gap:'1rem',justifyContent:'center',flexWrap:'wrap',marginBottom:'3rem'}}>
          <a href="mailto:vanegasbookings@gmail.com" style={{padding:'0.85rem 2rem',background:'#f5f2ed',color:'#0f0f0f',fontSize:'0.8rem',letterSpacing:'0.1em',textTransform:'uppercase',borderRadius:'2px',textDecoration:'none',fontWeight:500}}>Contact</a>
        ...
        <div style={{borderTop:'0.5px solid rgba(245,242,237,0.15)',paddingTop:'2rem',width:'100%',maxWidth:'400px'}}>
          <p style={{fontSize:'0.78rem',color:'rgba(245,242,237,0.4)'}}>vanegasbookings@gmail.com</p>
          <p style={{fontSize:'0.72rem',color:'rgba(245,242,237,0.2)',marginTop:'0.5rem'}}>© Vanegas · All rights reserved</p>
        </div>
      </div>
    </main>
  )
